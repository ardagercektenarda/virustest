...
public:
    explicit constexpr Atakan75Obf(const char(&a)[N])
...
template<u32 seed, std::size_t N>
std::ostream& operator<< (std::ostream& s, const Atakan75Obf<seed, N>& str) {
...
#define Atakan75p(STR) \
    Atakan75Obf<RNG_SEED, array_info<decltype(STR)>::size>{STR}